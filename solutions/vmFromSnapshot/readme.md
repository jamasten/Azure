...
New-AzResourceGroupDeployment `
    ...
    -TemplateUri 'https://raw.githubusercontent.com/battelle-cube/terraform-cube-avd/main/solutions/vmFromSnapshot/solution.json'
```
...
az deployment group create \
    ...
    --template-uri 'https://raw.githubusercontent.com/battelle-cube/terraform-cube-avd/main/solutions/vmFromSnapshot/solution.json'
````
