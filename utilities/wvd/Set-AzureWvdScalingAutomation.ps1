...
$Params = @{
     "UseARMAPI"             = $true
     "ResourceGroupName"     = "rg-shared-d-eastus"                # Optional. Default: "WVDAutoScaleResourceGroup"
     "AutomationAccountName" = "aa-jm-d-eastus2"            # Optional. Default: "WVDAutoScaleAutomationAccount"
     "Location"              = "eastus2"
     "WorkspaceName"         = "law-d-eastus"       # Optional. If specified, Log Analytics will be used to configure the custom log table that the runbook PowerShell script can send logs to
}
